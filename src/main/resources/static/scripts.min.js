...
var questionAndAnswer = angular.module('QuestionAndAnswer', ['ngResource', 'ngRoute', 'ngCookies', 'ngSanitize', 'ngAnimate', 'templates'])
		...
		.constant('appTitle', 'Question & Answer');var questionAndAnswer = angular.module('QuestionAndAnswer');
...
});angular.module("templates").run(["$templateCache", function($templateCache) {$templateCache.put("templates/home.html","");
