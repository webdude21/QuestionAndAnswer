...
$templateCache.put("templates/directives/answer.html","<blockquote class=blockquote-reverse><p>{{answer.content}}</p><span>{{answer.votesCount}}</span> <a href=# class=\"btn btn-success\" ng-click=upvote(answer.answerId)>Vote</a></blockquote>");
