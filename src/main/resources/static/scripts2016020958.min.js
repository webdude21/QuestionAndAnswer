...
$templateCache.put("templates/directives/question.html","<blockquote><p>{{question.title}}</p><small class=wrap>{{question.content}}</small></blockquote>");
...
$templateCache.put("templates/question/detail.html","<div class=row><question question={{vm.question}}></question></div>");
