...
$templateCache.put("templates/account/login.html","<div ng-controller=\"LoginController as vm\" class=navbar-right><form ng-hide=vm.identity.isAuthenticated() class=navbar-form><div class=form-group><input type=text placeholder=Username ng-model=vm.user.username class=form-control> <input type=password placeholder=Password ng-model=vm.user.password class=form-control></div><button ng-click=vm.login(vm.user) class=\"btn btn-primary\">Login</button> <a href=/register class=\"btn btn-primary\">Register</a></form><ul ng-show=vm.identity.isAuthenticated() class=\"nav navbar-nav navbar-right\"><li class=dropdown><a href data-toggle=dropdown class=dropdown-toggle>{{vm.identity.loggedInUser()}}<span class=caret></span></a><ul class=dropdown-menu><li><a href=# ng-click=vm.logout()>Sign Out</a></li></ul></li></ul></div>");
$templateCache.put("templates/account/register.html","<div class=container><div class=well><form name=signUpForm class=form-horizontal><fieldset><legend>Register</legend><div class=form-group><label for=first-name class=\"col-md-2 control-label\">First Name</label><div class=col-md-10><input type=text placeholder=\"First Name\" ng-minlength=2 ng-model=user.firstName required class=form-control></div></div><div class=form-group><label for=last-name class=\"col-md-2 control-label\">Last Name</label><div class=col-md-10><input type=text placeholder=\"Last Name\" ng-minlength=2 ng-model=user.lastName required class=form-control></div></div><div class=form-group><label for=email class=\"col-md-2 control-label\">Email</label><div class=col-md-10><input type=email placeholder=Email ng-model=user.email required class=form-control></div></div><div class=form-group><label for=password class=\"col-md-2 control-label\">Password</label><div class=col-md-10><input type=password placeholder=Password ng-minlength=8 ng-model=user.password required class=form-control></div></div><div class=pull-right><button ng-click=vm.register(user) ng-disabled=signUpForm.$invalid class=\"btn btn-primary\" disabled>Register</button> <a href=\"/\" class=\"btn btn-primary\">Cancel</a></div></fieldset></form></div></div>");
$templateCache.put("templates/directives/answer.html","<blockquote class=blockquote-reverse><p>{{answer.content}}</p><span>Votes: {{answer.votesCount}}</span> <a href=# class=\"btn btn-success\" ng-click=upVote(answer.answerId)>Vote</a> <a href=# class=\"btn btn-warning\" ng-click=unVote(answer.answerId)>Unvote</a></blockquote>");
