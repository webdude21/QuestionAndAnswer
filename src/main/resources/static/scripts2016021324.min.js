...
$templateCache.put("templates/directives/answer.html","<blockquote class=blockquote-reverse><p>{{answer.content}}</p><span>{{answer.votesCount}}</span></blockquote>");
